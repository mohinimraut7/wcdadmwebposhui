  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/company-register" element={<CompanyLayout><CompanyRegistration /></CompanyLayout>} />
        <Route path="/posh-survey" element={
          <CompanyLayout>
            <CompanyProtectedRoute>
              <PoshSurveyForm />
            </CompanyProtectedRoute>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route path="/surveys"                element={<Surveys />} />
          {/* ── 3 नवीन status pages ── */}
          <Route path="/complied-surveys"       element={<SurveyStatusPage statusFilter="compiled" />} />
          <Route path="/non-complied-surveys"   element={<SurveyStatusPage statusFilter="notcompiled" />} />
          <Route path="/rejected-surveys"       element={<SurveyStatusPage statusFilter="rejected" />} />
        </Route>
