...
//     e.preventDefault();
//     if (!form.email.trim())  { toast.error("Email enter करा"); return; }
//     if (!form.password)      { toast.error("Password enter करा"); return; }
//     try {
//       setLoading(true);
//       const res  = await axiosInstance.post("/org/login", {
...
//         .cl-subheading { color: rgba(44,61,131,0.55); font-size: 14px; margin-bottom: 24px; }
...
//                 <label className="cl-flbl">Email Address</label>
//                 <div className="cl-fwrap">
//                   <span className="cl-ficon"><FiMail size={16} /></span>
//                   <input
//                     className="cl-finput"
...
//                   { label: "Login",            desc: "Sign in with email & password", active: true },
...
// // const ORG_URL = (import.meta.env.VITE_API_BASE_URL || "http://127.0.0.1:8000/api/super-admin").replace("/super-admin", "/org");
// // import {
// //   FiShield, FiMail, FiLock, FiEye, FiEyeOff,
// //   FiLogIn, FiCheckSquare, FiMapPin, FiBriefcase,
// //   FiLock as FiLockSolid,
...
// //     try {
// //       setLoading(true);
// //       const res  = await axios.post(`${ORG_URL}/login`, {
// //         email:    form.email.trim(),
// //         password: form.password,
...
//     try {
//       setLoading(true);
//       const res  = await axiosInstance.post("/org/login-username", {
...
//     try {
//       setOtpLoading(true);
//       const res  = await axiosInstance.post("/org/send-otp", { concernmobile: mobile });
//       const data = res.data;
...
//     try {
//       setOtpLoading(true);
//       const res  = await axiosInstance.post("/org/verify-otp", {
